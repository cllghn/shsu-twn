    ...
    return (
        <div className="pt-4 px-10">
            ...
            <div className="space-y-4">
                ...
                <p>
                    <b>Nodes: </b>These are the entities or objects that form part of the network. In this case, we may have two different kinds of nodes:
                    <div className="px-2 py-2">
                        <CircleIcon sx={{ fontSize: 'small', fill: "#01161E" }} /><span className="pl-1 font-semibold">Sources:</span> Water sources (e.g., aquifers, reservoirs, groundwater, etc.) represent bodies of water that supply the water used for residential, industrial, agricultural, and other purposes.
                        <br />
                        <CircleIcon sx={{ fontSize: 'small', fill: "#53899D" }} /><span className="pl-1 font-semibold">Systems:</span> On the other hand, water systems (e.g., cities, utility districts, etc.) represent the entities that use or distribute the water.
                    </div>
                    In this dynamic visualization, properties about a nodes (e.g., name, water flow totals) can by accessed by hovering over it. Additionally, by clicking and holding on the node, you will be prompted to jump to the node's page, where you can find more information about it.
                </p>
                <p>
            ...
            <div className="space-y-4">
                ...
                <p>
                    <b>Water Supply Method: </b>This describes how a system obtains its water. The two main supply types are self-supply and purchased.
                </p>
                <p>
                    <b>Water Type: </b>This indicates the general classification of a water source based on where the water originates. There are two main categories, groundwater and surface water. If left blank, the water type is either unknown or not specified.
                </p>
            </div>
        </div>
    );
