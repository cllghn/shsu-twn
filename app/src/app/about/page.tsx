    ...
    return (
        <>
            <main className='container flex flex-col w-full m-28 mx-auto px-24 pt-14'>
                ...
                <h1 className='text-4xl font-bold text-left pb-10'>About</h1>
                    <p>
                ...
                <div className="w-full mt-10">
                    <h1 className='text-4xl font-bold text-left pt-10 pb-10'>Sponsorship</h1>
                    <p>
                ...
                <div className="w-full mt-10">
                    <h1 className='text-4xl font-bold text-left pt-10 pb-10'>Reproducibility</h1>
                    <p>
